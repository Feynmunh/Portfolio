...
function GlitchCanvas() {
  ...
  useEffect(() => {
    ...
    function draw() {
       ...
       ctx.fillStyle = CYAN; // Sky blue background
       ...
       for(let y = 0; y < rows; y++) {
         for(let x = 0; x < cols; x++) {
            ...
            if (val === 1) {
              ...
              ctx.fillStyle = CREME; // Creme block
              ctx.fillRect(x * cellSize, y * cellSize, cellSize - 1, cellSize - 1);
            }
         }
       }
...
function ScrollIndicator() {
  return (
    <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-3">
      ...
      {/* Animated line */}
      <div className="relative w-px h-12 overflow-hidden bg-black/10">
        <div
...
export default function HeroSection() {
  ...
  return (
    <section
      className="relative w-full overflow-hidden flex items-center justify-center bg-[#A4EBFB]"
